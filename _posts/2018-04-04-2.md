...
i3
```
# pacman -S i3-wm i3status i3blocks i3lock dmenu picom termite vim ranger feh cmus mpv scrot lxdm lxappearance ttf-font-awesome terminus-font
```
LXQt
```
# pacman -S lxqt lxdm
...
*Эта инструкция по установке Arch Linux сделана на основе [инструкции по установке из Arch Wiki](https://wiki.archlinux.org/title/Installation_guide_(Русский)) и [чек листа по установке и настройке Arch Linux Xfce от Алексея Бойко](https://docs.google.com/document/d/1IsTwkhYvYde9y3zTD1EscqockzdtdUYcItnAglYfZdU)*
