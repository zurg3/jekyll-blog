...
date:   2019-01-28 16:20:00 +0300
---
![Arch Linux](https://i.imgur.com/nkAhKiz.jpg)

За основу взято [руководство на HTML](https://zurg3.github.io/arch-linux-info/). Это перенесено на Markdown.
...
i3
```
# pacman -S i3 dmenu termite compton ttf-font-awesome scrot feh lxappearance lxdm ttf-dejavu
```
LXQt
```
...
### Обновление системы
Обновление всей системы (самого ядра, окружения рабочего стола, программ из pacman и из AUR) производится одной командой через aurman
```
$ aurman -Syu
```
